...
export default function Generos() {
    ...
    const refreshGeneros = async () => {
        const fet = 'https://apistreaming.juanangelcarrera.xyz/streaming/generos'
    ...
    const createGenero = async () => {
        ...
        const resp = await fetch('https://apistreaming.juanangelcarrera.xyz/streaming/generos', options)
            .then((response) => { return response.json() })
            .then((responseInJSON) => { return responseInJSON })
        refreshGeneros();
    }
