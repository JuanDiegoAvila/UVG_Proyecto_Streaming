...
export default function Body({ name, modal, setModal, movieview, setMovieView, profileModal, setProfileModal, anuncios, setAnuncios }) {
    ...
    const getMovies = async () => {
        let fet = "https://apistreaming.juanangelcarrera.xyz/streaming/pelis"
    ...
    useEffect(async () => {
        ...
        let fet1 = "https://apistreaming.juanangelcarrera.xyz/streaming/visto/" + idperfil
        ...
        let fet2 = "https://apistreaming.juanangelcarrera.xyz/streaming/viendo/" + idperfil
        ...
        let fet3 = "https://apistreaming.juanangelcarrera.xyz/streaming/fav/" + idperfil
        ...
        let fet4 = "https://apistreaming.juanangelcarrera.xyz/streaming/recom/" + idperfil
